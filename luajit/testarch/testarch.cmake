...
if (TARGET_TESTARCH MATCHES " LJ_ABI_BRANCH_TRACK 1")
    list(APPEND DASM_FLAGS -D BRANCH_TRACK)
    list(APPEND TARGET_ARCH "LJ_ABI_BRANCH_TRACK=1")
endif()

if (TARGET_TESTARCH MATCHES " LJ_ABI_SHADOW_STACK 1")
    list(APPEND DASM_FLAGS -D SHADOW_STACK)
    list(APPEND TARGET_ARCH "LJ_ABI_SHADOW_STACK=1")
endif()
