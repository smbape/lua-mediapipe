module.exports = ({language, cname}) => [
    ...
    [`mediapipe.tasks.core.TaskRunner.${ cname }`, "std::shared_ptr<mediapipe::tasks::core::TaskRunner>", ["/S", `/Call=mediapipe::${ language }::task_runner::create`], [
        ...
        [`mediapipe::${ language }::PacketsCallback`, "packets_callback", "nullptr", ["/RRef"]],
    ], "", ""],
    ...
    ["mediapipe.tasks.core.TaskRunner.GetGraphConfig", "std::shared_ptr<mediapipe::CalculatorGraphConfig>", ["=get_graph_config", "/WrapAs=reference_internal"], [], "", ""],
