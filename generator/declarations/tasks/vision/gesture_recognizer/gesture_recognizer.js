...
module.exports = ({language}) => {
    ...
    return [
        ...
        [`struct ${ nsProgId }.GestureRecognizerOptions`, "", [`/progid=${ progid }.GestureRecognizerOptions`, "/Simple", "/DC"], [
            ...
            ["GestureRecognizerResultCallback", "result_callback", "", ["/WType=GestureRecognizerResultRawCallback", `/WExpr=${ utils }::CppConvertToGestureRecognizerResultCallback($value, $0)`]],
        ], "", ""],
        ...
        [`${ nsProgId }.GestureRecognizer.Create`, `std::shared_ptr<${ fqn }>`, ["=create_from_options", "/S", `/WrapAs=${ utils }::ReleaseToSharedPtr`], [
            ["std::shared_ptr<GestureRecognizerOptions>", "options", "", ["/Expr=tasks::lua::core::utils::ConvertToUniquePtr($0)"]],
        ], "", ""],
        ...
        [`${ nsProgId }.GestureRecognizer.Close`, "absl::Status", ["=close", "/GU"], [], "", ""],
    ];
};
