...
module.exports = ({language}) => {
    ...
    return [
        ...
        [`struct ${ nsProgId }.PoseLandmarkerOptions`, "", [`/progid=${ progid }.PoseLandmarkerOptions`, "/Simple", "/DC"], [
            ...
            ["PoseLandmarkerResultCallback", "result_callback", "", ["/W"]],
        ], "", ""],
        ...
        [`${ nsProgId }.PoseLandmarker.Create`, `std::shared_ptr<${ fqn }>`, ["=create_from_options", "/S", `/WrapAs=${ utils }::ReleaseToSharedPtr`], [
            ["std::shared_ptr<PoseLandmarkerOptions>", "options", "", ["/Expr=tasks::lua::core::utils::ConvertToUniquePtr($0)"]],
        ], "", ""],
        ...
        [`${ nsProgId }.PoseLandmarker.Close`, "absl::Status", ["=close", "/GU"], [], "", ""],
    ];
};
