...
module.exports = ({language}) => {
    ...
    return [
        ...
        [`struct ${ nsProgId }.FaceLandmarkerOptions`, "", [`/progid=${ progid }.FaceLandmarkerOptions`, "/Simple", "/DC"], [
            ...
            ["FaceLandmarkerResultCallback", "result_callback", "", ["/W"]],
        ], "", ""],
        ...
        [`${ nsProgId }.FaceLandmarker.Create`, `std::shared_ptr<${ fqn }>`, ["=create_from_options", "/S", `/WrapAs=${ utils }::ReleaseToSharedPtr`], [
            ["std::shared_ptr<FaceLandmarkerOptions>", "options", "", ["/Expr=tasks::lua::core::utils::ConvertToUniquePtr($0)"]],
        ], "", ""],
        ...
        [`${ nsProgId }.FaceLandmarker.Close`, "absl::Status", ["=close", "/GU"], [], "", ""],
    ];
};
