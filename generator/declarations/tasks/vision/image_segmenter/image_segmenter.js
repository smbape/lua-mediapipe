...
module.exports = ({language}) => {
    ...
    return [
        ...
        [`struct ${ nsProgId }.ImageSegmenterOptions`, "", [`/progid=${ progid }.ImageSegmenterOptions`, "/Simple", "/DC"], [
            ...
            ["ImageSegmenterResultCallback", "result_callback", "", ["/W"]],
        ], "", ""],
        ...
        [`${ nsProgId }.ImageSegmenter.Create`, `std::shared_ptr<${ fqn }>`, ["=create_from_options", "/S", `/WrapAs=${ utils }::ReleaseToSharedPtr`], [
            ["std::shared_ptr<ImageSegmenterOptions>", "options", "", ["/Expr=tasks::lua::core::utils::ConvertToUniquePtr($0)"]],
        ], "", ""],
        ...
        [`${ nsProgId }.ImageSegmenter.Close`, "absl::Status", ["=close", "/GU"], [], "", ""],
    ];
};
