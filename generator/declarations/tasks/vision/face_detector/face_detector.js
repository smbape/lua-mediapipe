...
module.exports = ({language}) => {
    ...
    return [
        ...
        [`struct ${ nsProgId }.FaceDetectorOptions`, "", [`/progid=${ progid }.FaceDetectorOptions`, "/Simple", "/DC"], [
            ...
            ["FaceDetectorResultCallback", "result_callback", "", ["/W"]],
        ], "", ""],
        ...
        [`${ nsProgId }.FaceDetector.Create`, `std::shared_ptr<${ fqn }>`, ["=create_from_options", "/S", `/WrapAs=${ utils }::ReleaseToSharedPtr`], [
            ["std::shared_ptr<FaceDetectorOptions>", "options", "", ["/Expr=tasks::lua::core::utils::ConvertToUniquePtr($0)"]],
        ], "", ""],
        ...
        [`${ nsProgId }.FaceDetector.Close`, "absl::Status", ["=close", "/GU"], [], "", ""],
    ];
};
