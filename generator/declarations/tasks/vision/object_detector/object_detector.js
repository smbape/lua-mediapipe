...
module.exports = ({language}) => {
    ...
    return [
        ...
        [`struct ${ nsProgId }.ObjectDetectorOptions`, "", [`/progid=${ progid }.ObjectDetectorOptions`, "/Simple", "/DC"], [
            ...
            ["object_detector::ObjectDetectorResultCallback", "result_callback", "", ["/W"]],
        ], "", ""],
        ...
        [`${ nsProgId }.ObjectDetector.Create`, `std::shared_ptr<${ fqn }>`, ["=create_from_options", "/S", `/WrapAs=${ utils }::ReleaseToSharedPtr`], [
            ["std::shared_ptr<ObjectDetectorOptions>", "options", "", ["/Expr=tasks::lua::core::utils::ConvertToUniquePtr($0)"]],
        ], "", ""],
        ...
        [`${ nsProgId }.ObjectDetector.Close`, "absl::Status", ["=close", "/GU"], [], "", ""],
    ];
};
