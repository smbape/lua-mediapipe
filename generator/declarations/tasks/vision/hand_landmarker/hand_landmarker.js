...
module.exports = ({language}) => {
    ...
    return [
        ...
        [`struct ${ nsProgId }.HandLandmarkerOptions`, "", [`/progid=${ progid }.HandLandmarkerOptions`, "/Simple", "/DC"], [
            ...
            ["HandLandmarkerResultCallback", "result_callback", "", ["/W"]],
        ], "", ""],
        ...
        [`${ nsProgId }.HandLandmarker.Create`, `std::shared_ptr<${ fqn }>`, ["=create_from_options", "/S", `/WrapAs=${ utils }::ReleaseToSharedPtr`], [
            ["std::shared_ptr<HandLandmarkerOptions>", "options", "", ["/Expr=tasks::lua::core::utils::ConvertToUniquePtr($0)"]],
        ], "", ""],
        ...
        [`${ nsProgId }.HandLandmarker.Close`, "absl::Status", ["=close", "/GU"], [], "", ""],
    ];
};
