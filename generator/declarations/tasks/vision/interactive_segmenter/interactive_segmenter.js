...
module.exports = ({language}) => {
    ...
    return [
        ...
        [`${ nsProgId }.InteractiveSegmenter.Create`, `std::shared_ptr<${ fqn }>`, ["=create_from_options", "/S", `/WrapAs=${ utils }::ReleaseToSharedPtr`], [
            ["std::shared_ptr<InteractiveSegmenterOptions>", "options", "", ["/Expr=tasks::lua::core::utils::ConvertToUniquePtr($0)"]],
        ], "", ""],
        ...
        [`${ nsProgId }.InteractiveSegmenter.Close`, "absl::Status", ["=close", "/GU"], [], "", ""],
    ];
};
