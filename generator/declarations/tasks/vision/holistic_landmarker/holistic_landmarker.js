...
module.exports = ({language}) => {
    ...
    return [
        ...
        [`struct ${ nsProgId }.HolisticLandmarkerOptions`, "", [`/progid=${ progid }.HolisticLandmarkerOptions`, "/Simple", "/DC"], [
            ...
            ["HolisticLandmarkerResultCallback", "result_callback", "", ["/W"]],
        ], "", ""],
        ...
        [`${ nsProgId }.HolisticLandmarker.Create`, `std::shared_ptr<${ fqn }>`, ["=create_from_options", "/S", `/WrapAs=${ utils }::ReleaseToSharedPtr`], [
            ["std::shared_ptr<HolisticLandmarkerOptions>", "options", "", ["/Expr=tasks::lua::core::utils::ConvertToUniquePtr($0)"]],
        ], "", ""],
        ...
        [`${ nsProgId }.HolisticLandmarker.Close`, "absl::Status", ["=close", "/GU"], [], "", ""],
    ];
};
