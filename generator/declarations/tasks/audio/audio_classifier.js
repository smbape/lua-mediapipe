...
module.exports = ({language, self_get}) => {
    ...
    return [
        ...
        [`struct ${ nsProgId }.AudioClassifierOptions`, "", [`/progid=${ progid }.AudioClassifierOptions`, "/Simple"], [
            ...
            ["AudioClassifierResultCallback", "result_callback", "", ["/W"]],

            ["std::string", "display_names_locale", "", ["/RW", `/RExpr=${ self_get("classifier_options") }.display_names_locale`, `/WExpr=${ self_get("classifier_options") }.display_names_locale = $value`]],
            ...
            ["std::vector<std::string>", "category_allowlist", "", ["/RW", `/RExpr=${ self_get("classifier_options") }.category_allowlist`, `/WExpr=${ self_get("classifier_options") }.category_allowlist = $value`]],
            ["std::vector<std::string>", "category_denylist", "", ["/RW", `/RExpr=${ self_get("classifier_options") }.category_denylist`, `/WExpr=${ self_get("classifier_options") }.category_denylist = $value`]],
        ], "", ""],
        ...
        [`${ nsProgId }.AudioClassifier.Create`, `std::shared_ptr<${ fqn }>`, ["=create_from_options", "/S", `/WrapAs=${ utils }::ReleaseToSharedPtr`], [
            ["std::shared_ptr<AudioClassifierOptions>", "options", "", ["/Expr=tasks::lua::core::utils::ConvertToUniquePtr($0)"]],
        ], "", ""],
        ...
        [`${ nsProgId }.AudioClassifier.Close`, "absl::Status", ["=close", "/GU"], [], "", ""],
    ];
};
