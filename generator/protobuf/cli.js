...
const options = {
    proto_path: [
        fs.realpathSync(`${ __dirname }/../../out/build/x64-Debug/mediapipe/mediapipe-src`),
        fs.realpathSync(`${ __dirname }/../../out/build/x64-Debug/mediapipe/mediapipe-src/bazel-mediapipe-src/external/com_google_protobuf/src`),
    ],
    language: "lua",
    self: "*self",
    self_get: (name = null) => {
...
for (const filename of [
    ...
    parser.parseFile(fs.realpathSync(`${ __dirname }/../../out/build/x64-Debug/mediapipe/mediapipe-src/${ filename }`), options, outputs, cache);
}
