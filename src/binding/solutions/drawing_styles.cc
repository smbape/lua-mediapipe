...
namespace mediapipe::lua::solutions::drawing_styles {
	using namespace mediapipe::lua::solutions::face_mesh_connections;
	using namespace mediapipe::lua::solutions::hands_connections;
	using namespace mediapipe::lua::solutions::hands;
	using namespace mediapipe::lua::solutions::pose_connections;
	using namespace mediapipe::lua::solutions::pose;
