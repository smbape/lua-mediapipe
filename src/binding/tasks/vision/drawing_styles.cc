...
namespace {
	using namespace mediapipe::tasks::lua::vision::drawing_styles;
	using namespace mediapipe::tasks::lua::vision::drawing_utils;
...
namespace mediapipe::tasks::lua::vision::drawing_styles {
