...
namespace mediapipe::tasks::lua::components::containers::bounding_box {
	struct CV_EXPORTS_W_SIMPLE BoundingBox {
		...
		bool operator== (const BoundingBox& other) const {
			return ::mediapipe::lua::__eq__(origin_x, other.origin_x) &&
				::mediapipe::lua::__eq__(origin_y, other.origin_y) &&
