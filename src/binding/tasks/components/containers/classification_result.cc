...
namespace mediapipe::tasks::components::containers {
	...
	void CppConvertToClassificationsList(const std::vector<std::vector<Category>>& classifications_result, std::vector<Classifications>& classifications_list) {
	...
	void CppConvertToClassificationsList(const std::optional<std::vector<std::vector<Category>>>& classifications_result, std::optional<std::vector<Classifications>>& classifications_list) {
		if (classifications_result) {
			classifications_list.emplace();
			CppConvertToClassificationsList(*classifications_result, *classifications_list);
		} else {
