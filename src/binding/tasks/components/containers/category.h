...
namespace mediapipe::tasks::lua::components::containers::category {
	struct CV_EXPORTS_W_SIMPLE Category {
		...
		bool operator== (const Category& other) const {
			return ::mediapipe::lua::__eq__(index, other.index) &&
				::mediapipe::lua::__eq__(score, other.score) &&
				::mediapipe::lua::__eq__(display_name, other.display_name) &&
				::mediapipe::lua::__eq__(category_name, other.category_name);
		}
