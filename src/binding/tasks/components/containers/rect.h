...
namespace mediapipe::tasks::lua::components::containers::rect {
	struct CV_EXPORTS_W_SIMPLE Rect {
		...
		bool operator== (const Rect& other) const {
			return ::mediapipe::lua::__eq__(left, other.left) &&
				::mediapipe::lua::__eq__(top, other.top) &&
				::mediapipe::lua::__eq__(right, other.right) &&
				::mediapipe::lua::__eq__(bottom, other.bottom);
		}
	...
	struct CV_EXPORTS_W_SIMPLE NormalizedRect {
		...
		bool operator== (const NormalizedRect& other) const {
			return ::mediapipe::lua::__eq__(x_center, other.x_center) &&
				::mediapipe::lua::__eq__(y_center, other.y_center) &&
				::mediapipe::lua::__eq__(width, other.width) &&
				::mediapipe::lua::__eq__(height, other.height) &&
				::mediapipe::lua::__eq__(rotation, other.rotation);
		}
