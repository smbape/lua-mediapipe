...
namespace mediapipe::tasks::lua::text::text_embedder {
	...
	class CV_EXPORTS_W TextEmbedder : public ::mediapipe::tasks::lua::text::core::base_text_task_api::BaseTextTaskApi {
	public:
