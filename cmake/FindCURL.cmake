...
set(ZLIB_VERSION_SHA256 d7a0654783a4da529d1bb793b7ad9c3318020af77667bcae35f95d0e42a792f3)
...
# Remove BUILD.bazel because we will generate a more suitable BUILD.bazel
file(REMOVE "${zlib_SOURCE_DIR}/BUILD.bazel")
...
# libzstd is a cmake target, but we still need ZSTD_INCLUDE_DIR
...
set(BROTLI_VERSION_SHA256 816c96e8e8f193b40151dad7e8ff37b1221d019dbcb9c35cd3fadbfe6477dfec)
...
# brotlicommon is a cmake target, but we still need BROTLI_INCLUDE_DIR
...
# brotlienc is a cmake target, but we still need LIBBROTLIENC_INCLUDE_DIR
...
# brotlienc is a cmake target, but we still need LIBBROTLIDEC_INCLUDE_DIR
...
set(NGHTTP2_VERSION_SHA256 1fb324b6ec2c56f6bde0658f4139ffd8209fa9e77ce98fd7a5f63af8d0e508ad)
...
add_library(nghttp2::nghttp2_static ALIAS nghttp2_static)

set(NGHTTP2_FOUND TRUE)
set(NGHTTP2_LIBRARY nghttp2::nghttp2_static)
set(NGHTTP2_LIBRARIES ${NGHTTP2_LIBRARY})
# nghttp2::nghttp2 is a cmake target, but we still need NGHTTP2_INCLUDE_DIR
...
set(CURL_VERSION_SHA256 63fe2dc148ba0ceae89922ef838f7e5c946272c2e78b7c59fab4b79d3ce2b896)
