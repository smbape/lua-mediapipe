set(Lua_VERSION_55 5.5.0)
set(Lua_URL_HASH_550 57ccc32bbbd005cab75bcc52444052535af691789dba2b9016d5c50640d68b3d)

set(Lua_VERSION_54 5.4.8)
set(Lua_URL_HASH_548 4f18ddae154e793e46eeab727c59ef1c0c0c2b744e7b94219710d76f530629ae)
...
if ((NOT DEFINED Lua_VERSION) OR ("${Lua_VERSION} " STREQUAL " "))
    ...
    if ("${Lua_VERSION}" STREQUAL "5.5")
        set(Lua_VERSION "${Lua_VERSION_55}")
...
set_property(CACHE Lua_VERSION PROPERTY STRINGS "luajit-2.1" "${Lua_VERSION_55}" "${Lua_VERSION_54}" "${Lua_VERSION_53}" "${Lua_VERSION_52}" "${Lua_VERSION_51}")
