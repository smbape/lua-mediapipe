...
function(_lua_get_header_version)
  unset(Luajit_VERSION PARENT_SCOPE)
  set(_hdr_file "${LUA_INCLUDE_DIR}/luajit.h")

  if (EXISTS "${_hdr_file}")
    file(STRINGS "${_hdr_file}" Luajit_VERSION
       REGEX "^#define LUAJIT_VERSION[ \t]+\"LuaJIT ([0-9.]+)\"")
    string(REGEX MATCH "^#define LUAJIT_VERSION[ \t]+\"LuaJIT ([0-9.]+)\"" Luajit_VERSION "${Luajit_VERSION}")
    ...
    list(GET Luajit_VERSION_PARTS 2 Luajit_VERSION_PATCH)
